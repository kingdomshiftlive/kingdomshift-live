...
class FollowController extends BaseController {
    ...
    try {
      ...
      if (response.status == true) {
        ...
        if (_user != null &&
          ...
          FirebaseNotificationManager.instance.sendLocalisationNotification(LKey.notifyStartedFollowing,
  ...
  Future<StatusModel> _unFollowUser({required int userId}) async {
    StatusModel result = await UserService.instance.unFollowUser(userId: userId);
    if (result.status == true) {

...
extension Number on num {
  ...
  String get currencyFormat => '${SessionManager.instance.getCurrency()}${NumberFormat.compact().format(this)}';

  int get convertInt => toInt();

  UserLevel get getUserLevelByTotalCoins {
    List<UserLevel> userLevels = SessionManager.instance.getSettings()?.userLevels ?? [];

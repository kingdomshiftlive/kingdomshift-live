...
extension StringExtention on String {
  ...
  Future<StatusModel> get lunchUrlWithHttps async {
    ...
    try {
      bool result = await launchUrl(Uri.parse(url), mode: LaunchMode.externalApplication);
  ...
  String get formatDate => DateFormat('dd MMM, yyyy').format(DateTime.parse(this));

  String get formatDate1 => DateFormat('dd MMMM yyyy').format(DateTime.parse(this));

  String get formatDate2 => DateFormat('dd MMMM yy').format(DateTime.parse(this));
  ...
  Future<LinearGradient> get getGradientFromImage async {
    ...
    print(imageBytes);
    try {
      DominantColors extractor = DominantColors(bytes: imageBytes, dominantColorsCount: 5);

...
extension UserExtension on User {
  AppUser get appUser {
    return AppUser(username: username, userId: id, profile: profilePhoto, fullname: fullname, isVerify: isVerify);
  }
  ...
  LivestreamUserState streamState({LivestreamUserType stateType = LivestreamUserType.audience, required int time}) {

...
class AdsManager {
  ...
  static const _prodInterstitialAndroid = 'ca-app-pub-4518801081128136/1194138806';
  static const _prodInterstitialIos = 'ca-app-pub-4518801081128136/8881057133';

  String? _getBannerAdUnitId(Setting? setting) {
    if (!kReleaseMode) {
      logger('Getting Banner Ad Unit ID (Debug): ${Platform.isAndroid ? _testBannerAndroid : _testBannerIos}');
      return Platform.isAndroid ? _testBannerAndroid : _testBannerIos;
    }
    final id = Platform.isAndroid ? setting?.admobBanner : setting?.admobBannerIos;
    ...
    BannerAd(
      ...
      listener: BannerAdListener(
        ...
        onAdFailedToLoad: (ad, err) {
          logger('Banner Ad failed to load: $err. Error code: ${err.code}, Message: ${err.message}');
          ad.dispose();
        },
      ),
    ).load();
  ...
  Future<void> loadInterstitialAd({required Function(InterstitialAd) onAdLoaded}) async {
    ...
    await InterstitialAd.load(
        ...
        adLoadCallback: InterstitialAdLoadCallback(
          ...
          onAdFailedToLoad: (LoadAdError error) {
            logger('InterstitialAd failed to load: $error. Error code: ${error.code}, Message: ${error.message}');
          },
        ));
  }
  ...
  void requestConsentInfoUpdate() {
    final params = ConsentRequestParameters(
        consentDebugSettings: ConsentDebugSettings(
            debugGeography: DebugGeography.debugGeographyEea, testIdentifiers: ['D5E5A833CA124D2CD5E33A574AF9EA88']));

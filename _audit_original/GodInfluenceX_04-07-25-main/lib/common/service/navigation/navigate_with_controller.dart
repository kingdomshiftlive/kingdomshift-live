...
class NavigationService {
  ...
  Future<void> openProfileScreen(User? user, {bool isTopBarVisible = true, Function(User? user)? onUserUpdate}) async {
    await Get.to(() => ProfileScreen(user: user, isTopBarVisible: isTopBarVisible, onUserUpdate: onUserUpdate),

...
class _AddPostStory {
  ...
  String addPostFeedPodcast = "${apiURL}post/addPost_Feed_Podcast";
...
class _Post {
  ...
  String reportComment = "${apiURL}misc/reportComment";
  String reportStory = "${apiURL}misc/reportStory";
  ...
  String startRecording = "${apiURL}startRecording";
  String stopRecording = "${apiURL}stopRecording";
  String sendGift = "https://admin.godinfluencex.com/gifts";
}

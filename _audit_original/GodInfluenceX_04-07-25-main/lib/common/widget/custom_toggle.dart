      ...
      child: Obx(
        () => AnimatedContainer(
          ...
          decoration: ShapeDecoration(
              ...
              gradient: isOn.value ? StyleRes.themeGradient : StyleRes.textLightGreyGradient()),
          alignment: isOn.value ? AlignmentDirectional.centerEnd : AlignmentDirectional.centerStart,
          padding: const EdgeInsets.symmetric(horizontal: 3.5, vertical: 3),
          duration: const Duration(milliseconds: 300),
          child: Container(width: 20, decoration: BoxDecoration(shape: BoxShape.circle, color: whitePure(context))),
        ),
      ),
    );
  }

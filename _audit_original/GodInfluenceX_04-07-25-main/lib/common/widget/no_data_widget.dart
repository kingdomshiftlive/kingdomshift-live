                  ...
                  children: [
                    Center(
                      child: Text(
                        ...
                        style: TextStyleCustom.unboundedSemiBold600(color: textLightGrey(context), fontSize: 17),
...
class NoDataWidgetWithScroll extends StatelessWidget {
  ...
  const NoDataWidgetWithScroll({super.key, required this.title, required this.description});

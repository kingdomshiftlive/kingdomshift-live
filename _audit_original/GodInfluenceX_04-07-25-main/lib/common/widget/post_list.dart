...
class PostList extends StatelessWidget {
    ...
    return Stack(
      children: [
        NoDataView(
          ...
          description: isMe ? LKey.noMyPostsDescription.tr : LKey.noUserPostsDescription.tr,
  ...
  Widget _buildPostCard(Post post) {
    return PostCard(post: post, shouldShowPinOption: shouldShowPinOption, likeKey: GlobalKey());
  }
}

...
class PrivacyPolicyText extends StatelessWidget {
  ...
  const PrivacyPolicyText({super.key, this.regularTextColor, this.boldTextColor});
        ...
        Center(
          child: RichText(
            ...
            text: TextSpan(
                ...
                style: TextStyleCustom.outFitRegular400(color: regularTextColor ?? textLightGrey(context)),
                children: [
                  TextSpan(
                      text: '\n${LKey.privacyPolicy.tr}',
                      style: TextStyleCustom.outFitSemiBold600(color: boldTextColor ?? textLightGrey(context)),

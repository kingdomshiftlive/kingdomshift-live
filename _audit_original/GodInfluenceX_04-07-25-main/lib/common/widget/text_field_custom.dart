    ...
    return Column(
      ...
      children: [
        Padding(
          ...
          child:
              Text(widget.title, style: TextStyleCustom.outFitRegular400(color: textDarkGrey(context), fontSize: 17)),
        ),
        Container(
          height: widget.height,
          margin: const EdgeInsets.only(top: 8, bottom: 12),
          decoration: BoxDecoration(
              color: widget.isError ? ColorRes.likeRed.withValues(alpha: .1) : bgLightGrey(context),
              border: Border.symmetric(
                horizontal: BorderSide(color: widget.isError ? ColorRes.likeRed : Colors.transparent, width: .5),
              )),
          child: TextField(
            ...
            decoration: InputDecoration(
                ...
                hintStyle: TextStyleCustom.outFitLight300(color: textLightGrey(context), fontSize: 17),
                ...
                suffixIcon: widget.isPasswordField
                    ? InkWell(
                        ...
                        child: AnimatedSwitcher(
                            ...
                            child: Image.asset(!isHide ? AssetRes.icHideEye : AssetRes.icEye,
                                height: 24, width: 35, color: textLightGrey(context), key: UniqueKey())),
                      )
                    : null,
                ...
                prefixIcon: widget.isPrefixIconShow
                    ? InkWell(
                        onTap: () {
                          Get.bottomSheet(const PhoneCodesScreen(), isScrollControlled: true, ignoreSafeArea: false)
                              .then((value) {
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Obx(() => Text(
                                        ...
                                        style:
                                            TextStyleCustom.outFitLight300(fontSize: 17, color: whitePure(context)))),
                                    Icon(Icons.arrow_drop_down, color: whitePure(context), size: 30)
                                  ],
                                ),
                              )),
                        ),
            ...
            textAlignVertical: widget.isPrefixIconShow ? TextAlignVertical.center : null,

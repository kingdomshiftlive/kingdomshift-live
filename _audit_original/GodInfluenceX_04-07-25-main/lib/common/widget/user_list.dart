      ...
      children: [
        InkWell(
          ...
          child: Padding(
            ...
            child: Row(
              children: [
                CustomImage(size: const Size(40, 40), image: profilePhoto?.addBaseURL(), fullName: fullName),
                const SizedBox(width: 10),
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      FullNameWithBlueTick(username: userName, fontSize: 13, iconSize: 14, isVerify: isVerified),
                      Text(
                        fullName ?? '',

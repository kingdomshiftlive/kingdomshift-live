class LKey {
  ...
  static const String agreeToPolicy = "By proceeding forward, You agree to the,";
  ...
  static const String scanCodeToCheckProfile = "Scan This code\nto check the profile";
  ...
  static const String rechargeWallet = "Recharge your wallet. And\nsend gifts to your favorite creators.";
  ...
  static const String belowIsTheSummaryOfYourStream = "Below is the summary of your stream!";
  static const String fromBattle = "From Battle";
  static const String live = "Live";
  static const String checkProfile = "Check Profile";
  static const String youAreSendingCoinsTo = "You are sending coins to @color Participant";
  static const String youWillBeSentBackToMainView = "You will be sent back to main view in...";
  ...
  static const String enterEmail = "Please enter an email. The email field is empty.";
  static const String enterAPassword = "Please enter a password. The password field is empty.";
  static const String noUserFound = "No user found with that email. Please register with this email.";
  static const String incorrectPassword = "Incorrect password provided for this user.";
  static const String weakPassword = "The password provided is too weak.";
  static const String accountExists = "The account already exists for that email.";
  static const String fullNameEmpty = "Please enter a full name. The full name field is empty.";
  static const String usernameEmpty = "Please enter a username. The username field is empty.";
  static const String urlEmpty = "Please enter a URL link. The link field is empty.";
  static const String validUrl = "Please enter a valid URL link";
  static const String urlTitleEmpty = "Please enter a title. The title field is empty.";
  static const String validUsernameEmpty = "Please enter a valid username.";
  static const String confirmPasswordEmpty = "Please confirm your password. The confirm password field is empty.";
  static const String passwordMismatch = "The password and confirm password do not match.";
  static const String invalidEmail = "The email is incorrect. Please enter a valid email.";
  static const String verificationLinkSent =
      "A verification link has been sent to your email. Please verify the link to log in.";
  static const String verifyEmailFirst = "Please verify your email first, then proceed to log in.";
  ...
  static const String anErrorOccurredWhileApplyingTheVideoFilter = "An error occurred while applying the video filter.";
  static const String anErrorOccurredWhileCompressVideo = "An error occurred while compress the video.";
  ...
  static const String pinLimitExceededForComment = "You can pin maximum @pin_comment_count comment.";
  ...
  static const String terrorismOrExtremistContent = "Terrorism or Extremist Content";
  ...
  static const String provideReportReason = "Please provide a detailed reason for the report.";
  ...
  static const String noContentMessage = "There is nothing we can show you for now.";
  ...
  static const String discardEditsMessage = "If you go back now, you'll lose all the edits you've made.";
  static const String startAgainMessage = "If you go back now, you'll lose this draft";
  static const String discover = "Kingdom Connect";
  static const String noLocationFound = "No location found.";
  static const String startSearchingLocation = "Start searching for a location.";
  ...
  static const String youCanNotEnterMoreThanEtc = "You cannot enter more than @coin coins!";
  ...
  static const String cameraMicrophonePermissionTitle = "Allow Camera & Microphone Access";
  ...
  static const String deleteStoryMessage = "Are you sure you want to delete this story?";
  static const String deleteTextConfirmation = "Are you sure you want to delete this text?";
  static const String musicDownloadFailed = "Music download failed.";
  static const String viewMore = "View More";
  static const String downloadCompletedSuccessfully = "Download completed successfully!";
  ...
  static const String deleteChatUserDescription = "After deleting this user, you will not be able to restore the chat.";
  ...
  static const String enableCameraAndMicrophoneAccessTitle = "Enable Camera and Microphone Access";
  static const String enablePhotoAccessTitle = "Enable photos and videos access";
  ...
  static const String shareLimitMessage = "You can share with up to @share_chat_limit chats.";
  static const String chatRequestMessage = "@chat_user_name wants to chat with you. Approve it if you want to chat.";
  static const String cannotMessageBlockedUser = "You cannot send messages to this account unless you unblock them.";
  ...
  static const String deleteMusicMessage = "Are you sure you want to delete this music? This action cannot be undone.";
  static const String sessionExpiredTitle = "Session Expired – Logged in on Another Device";
  ...
  static const String textRejectedAndContainsSuchThings = "Text is rejected because it includes such things: ";
  static const String mediaRejectedAndContainsSuchThings = "Media is rejected because it contains such things: ";
  ...
  static const String endStreamMessage = "Do you really want to end this streaming?";
  static const String stopBattleTitle = "End Battle?";
  static const String stopBattleDescription = "Are you sure you want to stop the battle? This action can’t be undone.";
  static const String requestTitle = "No Join Requests Yet";
  static const String requestDescription = "View and manage audience requests to join the live stream.";
  ...
  static const String coHostListEmptyDescription = "Co-hosts will appear here once they accept your invitation.";
  static const String sendingCoinsMessage = "You are sending coins to the above user.";
  static const String noLivestreamsTitle = "No Live Streams Yet";
  static const String noLivestreamsDescription = "Live streams will appear here when someone goes live.";
  static const String noUserReelsTitle = "No Reels Yet";
  static const String noUserReelsDescription = "This user hasn’t posted any reels so far.";
  static const String noMyPostsTitle = "You Haven’t Shared Any Posts";
  static const String noMyPostsDescription = "Start posting to share your moments with the community.";
  static const String noUserPostsTitle = "No Posts Yet";
  static const String noUserPostsDescription = "This user hasn’t shared any posts so far.";
  static const String noUserPodcastsTitle = "No Podcasts Yet";
  static const String noUserPodcastsDescription = "This user hasn’t shared any podcasts so far.";
  static const String chatListEmptyTitle = "Start a Conversation";
  static const String chatListEmptyDescription = "Your chats will show up here once you start messaging someone.";
  static const String chatRequestEmptyTitle = "No Requests Right Now";
  static const String chatRequestEmptyDescription = "New chat requests will appear here when someone messages you.";
  static const String joinRequestSentDescription = "Your request to join the live stream is pending approval.";
  ...
  static const String requestingToJoinTheStream = "requesting to join the stream.";
  static const String requestDeclinedByHost = "The host has declined your request to join the live stream.";
  static const String requestJoinToHost = "Your request to join the live stream has been sent to the host.";
  static const String exitLiveStream = "Exit live stream?";
  static const String ifYouCheckThisProfileEtc = "If you check this profile, you will exit the live stream.";
  static const String cannotLeaveDuringBattle = "You can’t leave the live stream while a battle is in progress.";
  ...
  static const String scanQrProfileSearch = "Scan the QR of the profile you want to search.";
  static const String uploadFromGallery = "Upload From Gallery";
  static const String reelsEmptyTitle = "Nothing to Watch Yet";
  static const String reelsEmptyDescription = "Reels will appear here once new content is shared.";
  static const String searchPageEmptyTitle = "Nothing to Show Yet";
  static const String searchPageEmptyDescription = "Explore content by entering keywords in the search bar above.";
  ...
  static const String activityCommentedPost = "has commented on your post : @comment_description";
  static const String activityGIFComment = "has commented on your post with a GIF.";
  static const String activityReplyingToComment = "@username replied to your comment : @comment_description";
  ...
  static const String notifyReplyMentionedInComment = "has reply mentioned you in comment : @comment_description";
  ...
  static const String locationServicesDisabledTitle = "Location Services Are Still Disabled";
  ...
  static const String turnOnLocationServicesMessage = "To include nearby places, turn on location services.";
  static const String turnOnLocationServicesButton = "Turn on Location Services";
  static const String nothingToShowHere = "Nothing To Show Here";
  static const String userHidFollowings = "This user has decided not to show their followings.";
  static const String blockListEmptyTitle = "No Blocked Users";
  static const String blockListEmptyDescription = "Users you block will appear here. You haven’t blocked anyone yet.";
  static const String redeemMinCoinDescription = "You need to reach the minimum coin amount before you can redeem.";
  static const String userListEmptyTitle = "No Users Found";
  static const String userListEmptyDescription = "Users will appear here when available.";
  ...
  static const String subscriptionDescription = "@price / Month. Billed @unit_label";
  ...
  static const String minFollowersNeededToGoLive = "Min. @count Followers needed to go Live";
  static const String maxUserLinkAddDescription = "You can add only @limit links in the profile.";
  static const String refresh = "Refresh";
  static const String lost = "Lost";
  static const String connection = "Connection";
  static const String noInternetDesc = "It looks like you are not\nconnected to the internet";
  static const String downloadingFailed = "Download failed.";
  static const String from = "From";
  static const String somethingWentWrong = "Something went wrong.";
  static const String registrationBonusTitle = "🎉 Welcome Bonus Credited to Your Wallet!";
  ...
  static const String battleEndedGiftNotSent = "Oops!! Battle Ended Please wait for a while..";
  static const String cannotSendGiftToYourself = "You can't send gifts to yourself.";
  static const String liveStreamNotificationTitle = "Hey, @name is now live";
  static const String liveStreamNotificationBody = "Hurry up and join before it ends.";
  static const String livestreamHasEnded = "Livestream has ended.";
  static const String theHostHasTurnedOffYourVideo = "The host has turned off your Video.";
  static const String theHostHasTurnedOffYourAudio = "The host has turned off your Audio.";
  static const String theCoHostHasTurnedOffTheirVideo = "The Co-Host has turned off your Video.";
  static const String theCoHostHasTurnedOffTheirAudio = "The Co-Host has turned off your Audio.";

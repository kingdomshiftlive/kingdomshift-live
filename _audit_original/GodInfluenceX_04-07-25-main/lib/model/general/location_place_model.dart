class LocationPlaceModel {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (_contextualContents != null) {
      map['contextualContents'] = _contextualContents?.map((v) => v.toJson()).toList();
    }
...
class Places {
  ...
  Places.fromJson(dynamic json) {
    ...
    _displayName = json['displayName'] != null ? DisplayName.fromJson(json['displayName']) : null;
    ...
    _googleMapsLinks = json['googleMapsLinks'] != null ? GoogleMapsLinks.fromJson(json['googleMapsLinks']) : null;
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (_addressComponents != null) {
      map['addressComponents'] = _addressComponents?.map((v) => v.toJson()).toList();
    }
    if (_location != null) {
  ...
  String get description {
    final parts = [city, state, country].where((e) => e.trim().isNotEmpty).toList();
    return parts.join(', ');
  }

  String get placeTitle {
    final items = [title, shortCity, shortState, shortCountry].where((element) => element.trim().isNotEmpty).toList();
    return items.join(', ');
  }
}

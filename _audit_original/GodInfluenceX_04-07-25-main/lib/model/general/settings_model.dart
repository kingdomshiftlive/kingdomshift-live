...
class Setting {
  ...
  factory Setting.fromJson(Map<String, dynamic> json) => Setting(
        ...
        languages:
            json["languages"] == null ? [] : List<Language>.from(json["languages"]?.map((x) => Language.fromJson(x))),
        onBoarding: json["onBoarding"] == null
            ? []
            : List<OnBoarding>.from(json["onBoarding"]?.map((x) => OnBoarding.fromJson(x))),
        coinPackages: json["coinPackages"] == null
            ? []
            : List<CoinPackage>.from(json["coinPackages"]?.map((x) => CoinPackage.fromJson(x))),
        redeemGateways: json["redeemGateways"] == null
            ? []
            : List<RedeemGateway>.from(json["redeemGateways"]?.map((x) => RedeemGateway.fromJson(x))),
        gifts: json["gifts"] == null ? [] : List<Gift>.from(json["gifts"]?.map((x) => Gift.fromJson(x))),
        musicCategories: json["musicCategories"] == null
            ? []
            : List<MusicCategory>.from(json["musicCategories"]?.map((x) => MusicCategory.fromJson(x))),
        userLevels: json["userLevels"] == null
            ? []
            : List<UserLevel>.from(json["userLevels"]?.map((x) => UserLevel.fromJson(x))),
        dummyLives: json["dummyLives"] == null
            ? []
            : List<DummyLive>.from(json["dummyLives"]?.map((x) => DummyLive.fromJson(x))),
        reportReason: json["reportReasons"] == null
            ? []
            : List<ReportReason>.from(json["reportReasons"]?.map((x) => ReportReason.fromJson(x))),
        deepARFilters: json["deepARFilters"] == null
            ? []
            : List<DeepARFilters>.from(json["deepARFilters"]?.map((x) => DeepARFilters.fromJson(x))),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "onBoarding": onBoarding == null ? [] : List<dynamic>.from(onBoarding!.map((x) => x.toJson())),
        "coinPackages": coinPackages == null ? [] : List<dynamic>.from(coinPackages!.map((x) => x.toJson())),
        "redeemGateways": redeemGateways == null ? [] : List<dynamic>.from(redeemGateways!.map((x) => x.toJson())),
        "gifts": gifts == null ? [] : List<dynamic>.from(gifts!.map((x) => x.toJson())),
        "musicCategories": musicCategories == null ? [] : List<dynamic>.from(musicCategories!.map((x) => x.toJson())),
        "userLevels": userLevels == null ? [] : List<dynamic>.from(userLevels!.map((x) => x.toJson())),
        "dummyLives": dummyLives == null ? [] : List<dynamic>.from(dummyLives!.map((x) => x.toJson())),
        "reportReasons": reportReason == null ? [] : List<dynamic>.from(reportReason!.map((x) => x.toJson())),
        "deepARFilters": deepARFilters == null ? [] : List<dynamic>.from(deepARFilters!.map((x) => x.toJson())),
      };
}

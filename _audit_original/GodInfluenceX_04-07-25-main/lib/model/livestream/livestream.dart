...
class Livestream {
  ...
  List<AppUser> getAllUsers(List<AppUser> users) {
    AppUser? hostUser = users.firstWhereOrNull((element) => element.userId == hostId);
    final coHostUsers =
        coHostIds?.map((id) => users.firstWhereOrNull((user) => user.userId == id)).whereType<AppUser>().toList() ?? [];
  ...
  AppUser? getHostUser(List<AppUser> users) {
    ...
    AppUser? hostUser = controller.users.firstWhereOrNull((element) => element.userId == hostId);
    return hostUser;
  }
...
enum LivestreamType {
  ...
  static LivestreamType fromString(String value) {
    return LivestreamType.values.firstWhereOrNull((e) => e.value == value) ?? LivestreamType.livestream;
  }
}
...
enum BattleType {
  ...
  static BattleType fromString(String? value) {
    return BattleType.values.firstWhereOrNull((e) => e.value == value) ?? BattleType.initiate;
  }
}
...
enum BattleMode {
  ...
  static BattleMode fromString(String? value) {
    return BattleMode.values.firstWhereOrNull((e) => e.value == value) ?? BattleMode.oneVsOne;
  }
}
...
enum StreamLayout {
  ...
  static StreamLayout fromString(String? value) {
    return StreamLayout.values.firstWhereOrNull((e) => e.value == value) ?? StreamLayout.spotlight;
  }
}

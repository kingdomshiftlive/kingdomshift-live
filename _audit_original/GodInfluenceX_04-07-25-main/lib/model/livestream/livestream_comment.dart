...
class LivestreamComment {
  ...
  AppUser? get senderUser {
    ...
    return controller.users.firstWhereOrNull((element) => element.userId == senderId);
  }
  ...
  AppUser? get receiverUser {
    final controller = Get.find<FirebaseFirestoreController>();
    return controller.users.firstWhereOrNull((element) => element.userId == receiverId);
  }
...
enum LivestreamCommentType {
  ...
  static LivestreamCommentType fromString(String value) {
    return LivestreamCommentType.values.firstWhereOrNull((e) => e.value == value) ?? LivestreamCommentType.text;
  }
}

...
class ActivityNotification {
  ...
  ActivityNotification.fromJson(dynamic json) {
    ...
    type = json['type'] != null ? ActivityNotifyType.fromString(json['type']) : ActivityNotifyType.none;
    dataId = json['data_id'];
    createdAt = json['created_at'];
    updatedAt = json['updated_at'];
    data = json['data'] != null ? ActivityNotificationData.fromJson(json['data']) : null;

...
class RevCatPurchase {
  ...
  RevCatPurchase.fromJson(Map<String, dynamic> json) {
    ...
    revenueInUsd = json['revenue_in_usd'] != null ? RevenueInUsd.fromJson(json['revenue_in_usd']) : null;
    status = json['status'];
    store = json['store'];
...
class RevenueInUsd {
  ...
  RevenueInUsd({this.commission, this.currency, this.gross, this.proceeds, this.tax});

...
class User {
  ...
  User.fromJson(dynamic json) {
    ...
    followingIds = json["following_ids"] != null ? List<int>.from(json["following_ids"].map((x) => x)) : null;
    if (json['links'] != null) {
      links = [];
  ...
  void updateFollowerCount(bool isFollowing) {
    ...
    followerCount = ((followerCount ?? 0) + i).clamp(0, double.infinity).toInt(); // followerCount not less then 0
  }

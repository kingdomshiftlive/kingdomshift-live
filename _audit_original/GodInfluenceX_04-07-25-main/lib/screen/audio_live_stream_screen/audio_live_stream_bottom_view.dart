        ...
        children: [
          ...
          Obx(() {
            ...
            if (controller.isTextEmpty.value && !controller.isHost) {
              ...
              List<AppUser> users = controller.liveUsersStates.map((state) => state.user).whereType<AppUser>().toList();
              ...
              if (controller.liveData.value.hostId != null) {
                ...
                if (hostUser != null && !users.any((u) => u.userId == hostUser.userId)) {
              ...
              return IconButton(
                ...
                onPressed: controller.isTextEmpty.value ? null : controller.onTextCommentSend,
              );
            }
          }),
        ],

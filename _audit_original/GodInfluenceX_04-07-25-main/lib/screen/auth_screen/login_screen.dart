...
class LoginScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (kDebugMode) {
      controller.emailController.text = "kartikghosh770+1@gmail.com";
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        decoration: const ShapeDecoration(
          ...
          borderRadius: SmoothBorderRadius.vertical(top: SmoothRadius(cornerRadius: 0, cornerSmoothing: 1)),
        )),
        child: Stack(
          children: [
            const ThemeBlurBg(),
                              ...
                              child: InkWell(
                                ...
                                child: Padding(
                                    ...
                                    child: Text(LKey.forgetPassword.tr,
                                        style:
                                            TextStyleCustom.outFitRegular400(fontSize: 16, color: whitePure(context)))),
                              ),
                            ),
                          ),
                          TextButtonCustom(
                              onTap: controller.onLogin, title: LKey.logIn.tr, btnHeight: 50, horizontalMargin: 0)
                        ],
                      ),
                    ),
                    Padding(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(
                            ...
                            style: TextStyleCustom.outFitRegular400(fontSize: 16, color: whitePure(context)),
                          ),
                        ),
                        CustomDivider(
                          color: whitePure(context),
...
class LoginSheetTextField extends StatefulWidget {
  ...
  const LoginSheetTextField(
      {super.key, this.isPasswordField = false, required this.hintText, required this.controller, this.keyboardType});
    ...
    return Container(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          hintStyle: TextStyleCustom.outFitRegular400(color: whitePure(context), fontSize: 16),
          contentPadding: EdgeInsets.only(left: 10, right: 10, top: widget.isPasswordField ? 2 : 0),
          ...
          suffixIcon: widget.isPasswordField
              ? InkWell(
                  ...
                  child: AnimatedSwitcher(
                    ...
                    child: Image.asset(isHide ? AssetRes.icEye : AssetRes.icHideEye,
                        height: 24, width: 35, color: whitePure(context), key: UniqueKey()),
                  ),
                )
              : null,
        ),
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: Container(
        height: 57,
        width: 57,
        decoration: BoxDecoration(shape: BoxShape.circle, color: whitePure(context)),
        alignment: Alignment.center,

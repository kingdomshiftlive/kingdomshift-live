          ...
          Expanded(
            child: Obx(
              () => controller.isLoading.value && controller.blockedUsers.isEmpty
                  ? const LoaderWidget()
                  : NoDataView(
                      showShow: !controller.isLoading.value && controller.blockedUsers.isEmpty,
                      ...
                      child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            BlockUsers user = controller.blockedUsers[index];
                            return UserProfileTile(
                                actionName: ActionName.block,
                                onTap: () => controller.unblockUser(user.toUser, () {
                                      controller.blockedUsers
                                          .removeWhere((element) => element.toUserId == user.toUserId);
                                    }),

  ...
  Widget build(BuildContext context) {
    ...
    return Obx(
      () {
        ...
        var gradient = cameraEditController.storyGradientColor[cameraEditController.selectedBgIndex.value];
                ...
                ...controller.textWidgets.asMap().map(
                  (i, element) {
                    return MapEntry(
                        ...
                        DraggableTextWidget(
                          data: element,
                          onUpdate: (updatedData) => controller.updateTextWidget(i, updatedData),
...
class _DraggableTextWidgetState extends State<DraggableTextWidget> {
  ...
  double _initialRotationAngle = 0.0; // Initial rotation angle when scaling starts
  Offset _initialFocalPoint = Offset.zero; // Initial focal point for panning
  Offset _initialPosition = Offset.zero; // Position of the text when scaling starts
            ...
            Positioned(
              ...
              child: Transform(
                ...
                transform: Matrix4.identity()
                  ..translate(widget.data.left, widget.data.top)
                ...
                child: Container(
                  ...
                  child: Text(
                    ...
                    style: _getTextStyle(
                        widget.data.googleFontFamily, widget.data.fontSize, widget.data.fontColor, widget.data.opacity),
  ...
  TextStyle _getTextStyle(GoogleFontFamily? font, double fontSize, Color color, double opacity) {

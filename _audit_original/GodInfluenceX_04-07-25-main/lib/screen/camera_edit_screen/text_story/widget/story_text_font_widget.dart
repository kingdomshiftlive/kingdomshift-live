        ...
        children: [
          InkWell(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(color: whitePure(context).withValues(alpha: .3), shape: BoxShape.circle),
              alignment: Alignment.center,
              child: RotatedBox(
                  quarterTurns: 2,
                  child: Image.asset(AssetRes.icDownArrow_1, color: whitePure(context), width: 20, height: 20)),
            ),
          ),
          Expanded(
            child: Obx(
              () => ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return InkWell(
                    ...
                    child: Obx(
                      () {
                        bool isSelected = controller.selectedFontFamily.value == controller.outerFontFamilyList[index];
                        return Container(
                          height: 30,
                          alignment: Alignment.center,
                          ...
                          decoration: ShapeDecoration(
                              ...
                              color: isSelected ? whitePure(context) : blackPure(context).withValues(alpha: .2)),
                          child: Text(
                            fontFamily.fontName,
                            style: fontFamily.style
                                .copyWith(color: isSelected ? blackPure(context) : whitePure(context), fontSize: 16),
                          ),
                        );
                      },
                    ),

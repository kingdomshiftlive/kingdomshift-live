          ...
          Obx(() {
            ...
            if (iBlocked) {
              ...
              if (conversationUser.chatType == ChatType.request) {
                return ChatBottomRequestView(controller: controller, conversation: conversationUser);
              }
              return Stack(alignment: Alignment.center, children: [
                ChatTextField(
                    ...
                    actions: ChatAction.getChatActions(isGiphyEnabled: controller.setting?.gifSupport == 1)),
      ...
      child: Obx(() {
        ...
        return TextField(
          ...
          decoration: InputDecoration(
            ...
            hintStyle: TextStyleCustom.outFitLight300(color: textLightGrey(context)),
            ...
            prefixIcon: InkWell(
              ...
              child: AnimatedContainer(
                ...
                margin: EdgeInsets.only(
                    left: TextDirection.rtl == Directionality.of(context) ? 10 : 2,
                    right: TextDirection.ltr == Directionality.of(context) ? 10 : 2,
                    top: 2,
                    bottom: 2),
                ...
                child: Image.asset(AssetRes.icCamera, height: 25, width: 25, color: themeAccentSolid(context)),
              ),
            ),
                          ...
                          (index) {
                            return InkWell(
                              ...
                              child: Container(
                                ...
                                child: Image.asset(actions[index].image, width: 25, height: 25),
                              ),
                            );
                          },
                        ),
...
class ChatBottomRequestView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        children: [
          Text(LKey.chatRequestMessage.trParams({'chat_user_name': '${conversation.chatUser?.username}'}),
          ...
          Row(
            children: List.generate(
              ...
              (index) {
                ...
                return Expanded(
                  child: InkWell(
                    onTap: () => controller.onChatRequestTap(requestType, conversation),
                    child: Container(
                      height: 37,
                      ...
                      child: Text(
                        ...
                        style: TextStyleCustom.outFitRegular400(color: requestType.titleColor(context)),
                      ),
                    ),
                  ),
                );
        ...
        return Align(
          ...
          child: ClipRect(
            ...
            child: Container(
              ...
              child: controller.audioWidthAnimation!.value > 120 // Hide Row when width is too small
                  ? Row(
                      children: [
                        // Left icon
                        InkWell(
                          ...
                          child: AnimatedContainer(
                            ...
                            decoration:
                                BoxDecoration(shape: BoxShape.circle, color: ColorRes.likeRed.withValues(alpha: .1)),
                            alignment: Alignment.center,
                            child: Image.asset(AssetRes.icDelete, height: 25, width: 25, color: ColorRes.likeRed),
                          ),
                        ),
...
class ChatUnBlockedView extends StatelessWidget {
  ...
  const ChatUnBlockedView({super.key, required this.conversationUser, required this.onTapUnblock});
    ...
    return FittedBox(
      child: Padding(
        ...
        child: Column(
          spacing: 5,
          children: [
            Text(LKey.youBlockedUser.trParams({'block_user_name': '${conversationUser.chatUser?.username}'}),
                style: TextStyleCustom.outFitLight300(fontSize: 15, color: textLightGrey(context)),

...
class SendMediaSheet extends StatelessWidget {
  ...
  const SendMediaSheet({super.key, required this.image, required this.onSendBtnClick, required this.controller});
                ...
                child: ClipSmoothRect(
                  ...
                  child: Image.file(File(image),
                      ...
                      errorBuilder: (context, error, stackTrace) => Container(
                            ...
                            child:
                                Image.asset(AssetRes.icNoImage, height: 100, width: 100, color: textDarkGrey(context)),
                          )),
                ),
              ),
            ),

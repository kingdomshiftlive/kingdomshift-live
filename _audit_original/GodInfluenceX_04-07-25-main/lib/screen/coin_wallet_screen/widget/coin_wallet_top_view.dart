                    ...
                    children: <Widget>[
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            CustomBackButton(color: whitePure(context), width: 35),
                            Text(
                              LKey.coinWallet.tr,
                              ...
                              child: CustomPopupMenuButton(
                                  items: [
                                    ...
                                    MenuItem(LKey.requestWithdrawal.tr, () {
                                      Get.to(() => const RequestWithdrawalScreen())?.then((value) {
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                        color: whitePure(context).withValues(alpha: .2), shape: BoxShape.circle),
                                    child: Center(
                                        child: Image.asset(AssetRes.icMore,
                                            color: whitePure(context), width: 22, height: 22)),
                                  )),
                            )
                          ],
                        ),
                        ...
                        children: [
                          Obx(() {
                            ...
                            return Text(
                              ...
                              style: TextStyleCustom.unboundedExtraBold800(color: whitePure(context), fontSize: 40),
                            );
                          }),
                          Text(
                            LKey.balance.tr,
                            style: TextStyleCustom.outFitLight300(
                                color: whitePure(context).withValues(alpha: .8), fontSize: 18),
                          ),
                        ],
                      ),
                      const Spacer(),
                          ...
                          return Row(
                            ...
                            children: [
                              CoinWalletStatistics(
                                value: user?.coinCollectedLifetime?.toInt() ?? 0,
                                title: LKey.collected.tr,
                              ),
                              Container(height: 20, width: .5, color: whitePure(context)),
                              CoinWalletStatistics(
                              ...
                              Container(height: 20, width: .5, color: whitePure(context)),
                              CoinWalletStatistics(
                                value: user?.coinPurchasedLifetime?.toInt() ?? 0,
                      ...
                      Align(
                          ...
                          child: Padding(
                            ...
                            child: Text(
                              LKey.lifetime.tr,
                              style: TextStyleCustom.outFitLight300(fontSize: 13, color: whitePure(context)),
                            ),
                          ))
                    ],
                  ),
          ...
          Align(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(shape: BoxShape.circle, color: Colors.white, boxShadow: [
                  BoxShadow(color: Colors.black.withValues(alpha: .1), blurRadius: 18, offset: const Offset(0, 4))
                ]),
...
class CoinWalletStatistics extends StatelessWidget {
  ...
  const CoinWalletStatistics({super.key, required this.title, required this.value});
        ...
        Column(
          children: [
            Text(value.numberFormat,
                style: TextStyleCustom.unboundedMedium500(color: whitePure(context), fontSize: 13)),
            Text(title,
                style: TextStyleCustom.outFitLight300(color: whitePure(context).withValues(alpha: .8), fontSize: 15))
          ],
        ),
      ],
    );

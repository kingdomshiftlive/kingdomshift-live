...
class _ColorFilterScreenState extends State<ColorFilterScreen> {
  ...
  void _applyFilterToAll() {
    ...
    for (var i = 0; i < _images.length; i++) {
      _images[i] =
          ImageWithFilter(media: _images[i].media, colorFilter: selectedFilter, thumbnail: _images[i].thumbnail);
    }
    _images.refresh();
  }
          ...
          itemBuilder: (context, index) {
            ...
            return Container(
              ...
              child: ClipSmoothRect(
                  ...
                  child: ColorFiltered(
                    colorFilter: ColorFilter.matrix(imageWithFilter.colorFilter),
                    child: Image.file(
            ...
            children: [
              FittedBox(
                ...
                child: SizedBox(
                    ...
                    height: height,
                    child: ColorFiltered(
                      colorFilter: ColorFilter.matrix(_images.first.colorFilter),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        CustomBgCircleButton(
                          image: value.isPlaying ? AssetRes.icPause : AssetRes.icPlay,
        ...
        itemBuilder: (context, index) {
          ...
          return Obx(() {
            ...
            return FilterThumbnail(
              ...
              onTap: () => _applyFilterToSelected(_selectedImageIndex.value, filter.colorFilter),
              path: thumbnailPath,
                ...
                children: [
                  ...
                  ClipSmoothRect(
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        border: Border.all(
                            color: isSelected ? whitePure(context) : whitePure(context).withValues(alpha: .2),
                            width: 1.5),
                        borderRadius: SmoothBorderRadius(
                          cornerRadius: 10,
                          cornerSmoothing: 1,

...
class _ColorFiltersViewState extends State<ColorFiltersView> {
  PageController pageController = PageController(initialPage: 0, viewportFraction: .2, keepPage: true);
        ...
        children: [
                    ...
                    return Transform.scale(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(
                            color: isSelected ? Colors.transparent : whitePure(context).withValues(alpha: 0.3),
                            width: 3,
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            shape: BoxShape.circle,
                            color: isZeroIndex ? Colors.transparent : Colors.white,
                            image: isZeroIndex
                                ? null
                                : widget.image == null || (widget.image ?? '').isEmpty
                                    ? DecorationImage(
                                        image: const AssetImage(AssetRes.greyPicture),
                                        fit: BoxFit.cover,
                              ...
                              : widget.image == null
                                  ? ClipOval(
                                      child: BackdropFilter(
                                          filter: ImageFilter.blur(sigmaX: 1.2, sigmaY: 1.2), child: Container()),
                                    )
                                  : const SizedBox(),
                        ),
                      ),
          ...
          IgnorePointer(
            child: Container(
              ...
              alignment: Alignment.center,
              decoration:
                  BoxDecoration(shape: BoxShape.circle, border: Border.all(color: whitePure(context), width: 3)),
            ),
          ),
        ],
      ),

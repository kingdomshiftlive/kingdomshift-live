...
class HashTagAndMentionUserView extends StatelessWidget {
  ...
  const HashTagAndMentionUserView({super.key, required this.helper, this.height, this.bottomViewSpace});
                ...
                : items.isEmpty
                    ...
                    : Container(
                        ...
                        child: ListView.builder(
                            ...
                            shrinkWrap: true,
                            primary: false,
                            padding: EdgeInsets.only(top: 5, left: 13, right: 13, bottom: bottomViewSpace ?? 0.0),

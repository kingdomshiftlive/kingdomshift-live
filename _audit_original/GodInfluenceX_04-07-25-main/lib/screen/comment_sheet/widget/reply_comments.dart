...
class ReplyCommentsView extends StatelessWidget {
  ...
  const ReplyCommentsView({super.key, required this.replyComments, required this.controller});
  ...
  Widget build(BuildContext context) {
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        bool isNotify = false;
        if (controller.isFromNotification == true && controller.commentBlinkId == null) {

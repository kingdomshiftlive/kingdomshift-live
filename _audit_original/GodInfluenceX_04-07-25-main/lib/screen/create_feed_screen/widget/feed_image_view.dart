...
class FeedImageView extends StatelessWidget {
  ...
  const FeedImageView({super.key, required this.files, required this.controller});
                    ...
                    PageView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return file.colorFilter.isNotEmpty
                              ? ColorFiltered(
                                  colorFilter: ColorFilter.matrix(file.colorFilter), child: _file(file.media.path))
                      ...
                      children: [
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              if (files.length < (controller.setting.value?.maxImagesPerPost ?? AppRes.imageLimit))
                                CustomBgCircleButton(image: AssetRes.icPlus, onTap: controller.selectImages),
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              CustomPageIndicator(length: files.length, selectedIndex: controller.selectedImageIndex),
                              Padding(
  ...
  Widget _file(String path) {
    return Image.file(File(path), height: Get.width, width: Get.width, fit: BoxFit.cover);
  }
}

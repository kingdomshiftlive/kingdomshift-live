  ...
  Widget build(BuildContext context) {
    return Obx(
      () {
        ...
        VideoPlayerController? playerController = controller.videoPlayerController.value;
                                ...
                                if (controller.videoPlayerController.value != null) {
                                  ...
                                  Get.bottomSheet(
                                          ColorFilterScreen(
                                            images: [video],
                                            onChanged: (items) {
                                              controller.video.value = items.first;
                                            },
                                  ...
                                  Loggers.error('Video Player controller not found');
                                }
                              },
                            ),
                          ...
                          children: [
                            SizedBox(
                                ...
                                child: Text(
                                  ...
                                  style: TextStyleCustom.outFitMedium500(color: whitePure(context), fontSize: 12),
                                )),
                            Expanded(
                              child: Slider(
                                ...
                                onChanged: (value) {
                                  playerController.seekTo(Duration(microseconds: value.toInt()));
                                },
                              ),
                            ),
                            Container(

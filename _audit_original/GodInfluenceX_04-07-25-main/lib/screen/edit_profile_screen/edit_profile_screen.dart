                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(LKey.profileImage.tr,
                        style: TextStyleCustom.outFitRegular400(fontSize: 17, color: textDarkGrey(context))),
                  ),
                  Container(
                    height: 100,
                        ...
                        children: [
                          Obx(
                            () => controller.fileProfileImage.value != null
                                ? ClipOval(
                                    child: Image.file(File(controller.fileProfileImage.value?.path ?? ''),
                          ...
                          Positioned(
                            ...
                            child: Container(
                              height: 26,
                              width: 26,
                              decoration: BoxDecoration(color: textDarkGrey(context), shape: BoxShape.circle),
                              child: Center(
                                child: Image.asset(AssetRes.icEdit_1, width: 22, height: 22, color: whitePure(context)),
                              ),
                            ),
                          )
                        ],
                  ...
                  TextFieldCustom(controller: controller.bioController, title: LKey.bio.tr, height: 100),
                  TextFieldCustom(
                  ...
                  TextFieldCustom(
                      controller: controller.phoneNumberController, title: LKey.phoneNumber.tr, isPrefixIconShow: true),

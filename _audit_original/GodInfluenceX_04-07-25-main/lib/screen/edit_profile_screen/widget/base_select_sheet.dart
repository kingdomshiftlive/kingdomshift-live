...
Widget _buildListItem<T>(
  ...
  return GestureDetector(
    onTap: onTap,
    child: Container(
      color: isSelected ? themeAccentSolid(context).withValues(alpha: 0.2) : bgLightGrey(context),
      ...
      child: Row(
        children: [
          Expanded(
            ...
            displayText,
            style: style ??
                TextStyleCustom.outFitRegular400(color: isSelected ? themeAccentSolid(context) : blackPure(context)),
          )),
          const SizedBox(width: 20),
          if (secondaryText != null) ...[
            Text(secondaryText,
                style: TextStyleCustom.outFitRegular400(
                    color: isSelected ? themeAccentSolid(context) : blackPure(context))),
          ],
        ],
      ),
    ),

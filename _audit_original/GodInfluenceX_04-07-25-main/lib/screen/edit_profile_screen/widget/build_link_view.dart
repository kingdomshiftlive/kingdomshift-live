    ...
    return Column(
      ...
      children: [
        Padding(
          ...
          child: Row(
            children: [
              Text(LKey.links.tr, style: TextStyleCustom.outFitRegular400(color: textDarkGrey(context), fontSize: 17)),
              const SizedBox(width: 5),
              InkWell(
                  onTap: controller.openAddEditLinkSheet,
                  child: Icon(CupertinoIcons.plus_circle_fill, color: textDarkGrey(context), size: 22))
            ],
          ),
        ),
                  ...
                  child: Row(
                    children: [
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Text(
                              link.title ?? '',
                              style: TextStyleCustom.unboundedMedium500(color: textDarkGrey(context), fontSize: 15),
                            ),
                            const SizedBox(height: 5),
                            Text(
                              link.url ?? '',
                      ...
                      PopupMenuButton<LinkType>(
                        ...
                        popUpAnimationStyle:
                            const AnimationStyle(curve: Curves.linear, duration: Duration(milliseconds: 500)),
                        child: Container(
                          height: 36,
                          width: 36,
                          decoration: BoxDecoration(shape: BoxShape.circle, color: bgGrey(context)),
                          alignment: Alignment.center,
                          child: Image.asset(AssetRes.icMore, height: 22, width: 22),
                        ),
                      ),
                    ],
                  ),

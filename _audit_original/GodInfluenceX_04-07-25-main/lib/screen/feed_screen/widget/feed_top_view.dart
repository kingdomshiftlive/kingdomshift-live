                ...
                () => SingleChildScrollView(
                  ...
                  child: Row(
                    children: PostCategory.values.map((category) {
                      final isSelected = controller.selectedPostCategory.value == category;
                      return Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                ...
                                style: isSelected
                                    ? TextStyleCustom.unboundedBold700(color: textDarkGrey(context), fontSize: 13)
                                    : TextStyleCustom.unboundedRegular400(color: textLightGrey(context), fontSize: 13),
                              ),
              ...
              child: SizedBox(
                ...
                child: Stack(
                  ...
                  children: [
                    ...
                    Obx(() {
                      int notifyCount = SessionManager.instance.notifyCount.value;
                      if (notifyCount <= 0) {

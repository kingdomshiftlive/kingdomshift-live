      ...
      child: Column(
        children: [
          ...
          CustomSearchTextField(
            ...
            hintText: LKey.searchGiphy.trParams({'brand_name': AppRes.gifBrandName}),
          ),
          Expanded(child: Obx(
            () {
              bool isTextEmpty = controller.isTextEmpty.value;
              List<GiphyData> items = isTextEmpty ? controller.trendingList : controller.searchingGiphyList;
              ...
              return isLoading
                  ...
                  : NoDataView(
                      ...
                      child: LoadMoreWidget(
                        loadMore: isTextEmpty ? controller.fetchTrendingGiphy : controller.fetchSearchGiphy,
                        child: GridView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            double width = double.parse(data.images?.original?.width ?? '100');
                            double height = double.parse(data.images?.original?.height ?? '100');
                            return CustomImage(

      ...
      child: AspectRatio(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              CustomImage(image: widget.gift.image?.addBaseURL(), size: const Size(90, 90), radius: 0),
              ...
              GradientText(LKey.successfully.tr,
                  gradient: StyleRes.themeGradient, style: TextStyleCustom.unboundedSemiBold600(fontSize: 15)),
            ],
          ),
        ),
      ),

...
class LevelScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    List<UserLevel> levels = SessionManager.instance.getSettings()?.userLevels ?? [];
                      ...
                      child: Column(
                        children: [
                          Text(
                            ...
                            style: TextStyleCustom.unboundedExtraBold800(fontSize: 44, color: whitePure(context)),
                          ),
                          const SizedBox(height: 14),
                          Text(
                            LKey.gatherMoreCoins.tr,
                            style: TextStyleCustom.outFitRegular400(fontSize: 18, color: whitePure(context)),
              ...
              itemBuilder: (context, index) {
                ...
                return Container(
                  ...
                  child: GradientBorder(
                    strokeWidth: 2,
                    radius: 10,
                    gradient: isLevelCurrent ? StyleRes.themeGradient : StyleRes.textLightGreyGradient(opacity: .2),
                    child: Container(
                      decoration: ShapeDecoration(
                          shape: SmoothRectangleBorder(
                              borderRadius: SmoothBorderRadius(cornerRadius: 10, cornerSmoothing: 1),
                              side: BorderSide(
                                color: textLightGrey(context).withValues(alpha: 0),
                              )),
                      ...
                      child: Row(
                        ...
                        children: [
                          SizedBox(
                            ...
                            child: GradientText(
                              '${level.level}.',
                              gradient: isLevelCurrent ? StyleRes.themeGradient : StyleRes.textLightGreyGradient(),
                              style: TextStyleCustom.outFitBlack900(color: textLightGrey(context), fontSize: 35),
                            ),
                          ),
                          SizedBox(
                            width: Get.width / 4,
                            child: ShaderMask(
                              ...
                              shaderCallback: (bounds) =>
                                  (isLevelCurrent ? StyleRes.themeGradient : StyleRes.textLightGreyGradient())
                                      .createShader(
                              ...
                              child: RichText(
                                  text: TextSpan(
                                text: LKey.level.tr,
                                style: TextStyleCustom.outFitRegular400(color: textLightGrey(context), fontSize: 17),
                                children: [
                                  TextSpan(
                                      text: '  ${level.level}',
                                      style: TextStyleCustom.outFitBold700(color: textLightGrey(context), fontSize: 17))
                                ],
                              )),
                            ),
                          ),
                          Container(
                            ...
                            child: !isLevelCurrent
                                ...
                                : Text(
                                    LKey.you.tr,
                                    style: TextStyleCustom.outFitSemiBold600(color: whitePure(context), fontSize: 15),
                                  ),
                          ),
                          SizedBox(
                            width: Get.width / 5,
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(level.coinsCollection.numberFormat,
                                    style:
                                        TextStyleCustom.outFitRegular400(fontSize: 20, color: textLightGrey(context))),
                              ],
                            ),
                          )
                        ],

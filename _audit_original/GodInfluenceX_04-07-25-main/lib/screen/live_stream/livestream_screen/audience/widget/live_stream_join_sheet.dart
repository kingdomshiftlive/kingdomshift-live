...
class LiveStreamJoinSheet extends StatelessWidget {
  ...
  const LiveStreamJoinSheet({super.key, this.hostUser, this.myUser, this.onJoined, this.onCancel});
              ...
              children: [
                ...
                RichText(
                  text: TextSpan(
                      ...
                      style: TextStyleCustom.outFitSemiBold600(color: textLightGrey(context), fontSize: 16),
                      children: [
                        TextSpan(

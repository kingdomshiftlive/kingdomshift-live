        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 20),
              Obx(() {
                final currentLayout = controller.liveData.value.streamLayout ?? StreamLayout.spotlight;
...
class _LayoutOption extends StatelessWidget {
            ...
            child: Container(
              decoration: ShapeDecoration(
                shape: SmoothRectangleBorder(
                  ...
                  side: BorderSide(
                    color: isSelected ? themeAccentSolid(context) : textLightGrey(context).withValues(alpha: .3),
  ...
  Widget _buildLayoutPreview(BuildContext context) {
    final Color c1 = isSelected ? Colors.white.withValues(alpha: .4) : textLightGrey(context).withValues(alpha: .3);
    final Color c2 = isSelected ? Colors.white.withValues(alpha: .25) : textLightGrey(context).withValues(alpha: .2);

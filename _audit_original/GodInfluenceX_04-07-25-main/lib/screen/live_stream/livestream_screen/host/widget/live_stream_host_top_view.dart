...
import 'package:shortzz/screen/live_stream/livestream_screen/host/widget/layout_picker_sheet.dart';
        ...
        child: Obx(
          () {
            ...
            LivestreamUserState? userState =
                controller.liveUsersStates.firstWhereOrNull((element) => element.userId == stream.hostId);
            bool isVisibleBattleBtn = stream.battleType == BattleType.initiate &&
                ...
                child: Container(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        // Row 1: Stop, Eye count, Coin count, Share, Audience, Layout
                        Row(
                          spacing: 3,
                          children: [
                            ...
                            LiveStreamBorderButton(
                                title: (userState?.totalCoin ?? 0).numberFormat, imageIcon: AssetRes.icCoin),
                            const Spacer(),
                            LiveStreamCircleBorderButton(
                              ...
                              onTap: () {
                                BranchIoManager.instance.shareContent(
                                    type: ShareBranchType.liveStream, livestream: controller.liveData.value);
                              },
                            ),
                            LiveStreamCircleBorderButton(
                              ...
                              iconColor: whitePure(context),
                              onTap: () {
                                Get.bottomSheet(const MembersSheet(isHost: true), isScrollControlled: true);
                              },
                            ),
                            if (controller.streamViews.length >= 2)
                              InkWell(
                                onTap: () {
                                  HapticManager.shared.light();
                                  Get.bottomSheet(
                                    LayoutPickerSheet(controller: controller),
...
class StopLiveStreamSheet extends StatelessWidget {
  ...
  const StopLiveStreamSheet({super.key, required this.onTap, this.title, this.description, this.positiveText});
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                ...
                style: TextStyleCustom.unboundedRegular400(fontSize: 15, color: textDarkGrey(context)),
              ),
              Text(
                description ?? LKey.endStreamMessage.tr,
                style: TextStyleCustom.outFitLight300(fontSize: 17, color: textLightGrey(context)),
              ),
                ...
                children: [
                  Expanded(
                    child: TextButtonCustom(
                        onTap: Get.back, title: LKey.cancel.tr, backgroundColor: bgMediumGrey(context)),
                  ),
                  Expanded(
                      child: TextButtonCustom(
                          onTap: () {
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Row(
          ...
          spacing: 3,
          children: [
            if (imageIcon.isNotEmpty) Image.asset(imageIcon, height: 16, width: 16, color: imageColor),
            Text(title, style: TextStyleCustom.outFitRegular400(color: whitePure(context))),
          ],
        ),
      ),
    );

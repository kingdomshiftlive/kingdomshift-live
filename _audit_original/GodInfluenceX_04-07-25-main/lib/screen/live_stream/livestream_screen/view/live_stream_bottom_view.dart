...
class LiveStreamBottomView extends StatelessWidget {
  ...
  const LiveStreamBottomView({super.key, this.isAudience = false, required this.controller});
            ...
            SafeArea(
              ...
              child: Column(
                ...
                children: [
                          ...
                          children: [
                            ...
                            Row(spacing: 5, children: [
                              ...
                              Expanded(
                                ...
                                child: IgnorePointer(
                                  ignoring: !isVisible,
                                  child: LiveStreamTextFieldView(isAudience: isAudience, controller: controller),
                                ),
                              )),
                              AnimatedOpacity(
                                duration: animationDuration,
                            ...
                            Obx(
                              () {
                                ...
                                LivestreamUserState? userState =
                                    controller.liveUsersStates.firstWhereOrNull((element) => element.userId == userId);
                                if (userState == null) return const SizedBox();
                                final isHostOrCoHost = userState.type == LivestreamUserType.host ||
                                ...
                                return Row(
                                  ...
                                  spacing: 10,
                                  children: [
                                    if (LivestreamUserType.coHost == userState.type &&
                                        stream.type == LivestreamType.livestream)
                                      LiveStreamCircleBorderButton(
                                          onTap: () {
                                            if (isBattleRunning) {
                                              controller.showSnackBar(LKey.cannotLeaveDuringBattle.tr);
                                            } else {
                                          ...
                                          borderColor: ColorRes.likeRed.withValues(alpha: .2)),
                                    LiveStreamCircleBorderButton(
                                        image: AssetRes.icFlip, onTap: controller.toggleFlipCamera),
                                    LiveStreamCircleBorderButton(
                                        image: userState.audioStatus == VideoAudioStatus.on
                                            ? AssetRes.icMicrophone
                                            : AssetRes.icMicOff,
                                        onTap: () => controller.toggleMic(userState)),
                                    LiveStreamCircleBorderButton(
                                        image: userState.videoStatus == VideoAudioStatus.on
                                            ? AssetRes.icVideoCamera
                                            : AssetRes.icVideoOff,
                                        onTap: () => controller.toggleVideo(userState)),
                                    // screen share button
                                    controller.isScreenShareAvailable.value
                                        ? GestureDetector(
                                            onTap: () {
                                            ...
                                            child: Container(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                    controller.isScreenSharing.value ? 'Stop' : 'Share',
                  ...
                  Obx(() {
                    Livestream stream = controller.liveData.value;
                    if ((stream.type == LivestreamType.battle && stream.battleType == BattleType.end) ||
                        controller.isMinViewerTimeout.value) {
                      return LivestreamExistMessageBar(controller: controller, stream: stream);
                    } else {

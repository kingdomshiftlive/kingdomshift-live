...
class MultiBattleView extends StatelessWidget {
              ...
              child: Obx(() {
                ...
                return ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    return _buildParticipantItem(context, participants[index], index);
                  },
                );
              }),
            ),
  ...
  List<LivestreamUserState> _getParticipants() {
    return controller.liveUsersStates
        .where((e) => e.type == LivestreamUserType.host || e.type == LivestreamUserType.coHost)
        .toList();
  }

  Widget _buildParticipantItem(BuildContext context, LivestreamUserState state, int rank) {
    ...
    return Container(
      ...
      decoration: ShapeDecoration(
        ...
        shape: SmoothRectangleBorder(
          ...
          side: isLeader ? const BorderSide(color: Colors.yellow, width: 2) : BorderSide.none,
        ),
      ),
      child: Column(
        ...
        children: [
          ...
          if (rank < 3)
            Container(
              ...
              child: Text(
                '#${rank + 1}',
                style: TextStyleCustom.unboundedBold700(fontSize: 10, color: Colors.white),
              ),
            ),
          ...
          Row(
            ...
            children: [
              ...
              Text(
                ...
                style: TextStyleCustom.outFitBold700(fontSize: 12, color: Colors.white),
              ),
            ],
          ),
        ],

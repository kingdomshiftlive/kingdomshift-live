...
class LocationScreen extends StatelessWidget {
  ...
  const LocationScreen({super.key, required this.latLng, required this.placeTitle});

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(LocationScreenController(latLng.obs, placeTitle.obs),
              ...
              children: [
                InkWell(
                  ...
                  child: Container(
                    ...
                    child: Image.asset(AssetRes.icClose, color: textLightGrey(context), height: 20, width: 20),
                  ),
                ),
                Expanded(
                      ...
                      builder: (context, scrollController) {
                        return Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            boxShadow: [
                              BoxShadow(
                                  color: blackPure(context).withValues(alpha: 0.15),
                                  offset: const Offset(0, 4),
                                  blurRadius: 11.6)
                            ],
                          ),
  ...
  Widget customWidget(BuildContext context, LocationScreenController controller) {
    return Container(
      height: 155,
      color: whitePure(context),
      child: Column(
        ...
        children: [
          Center(
            child: CustomDivider(
                color: bgGrey(context), margin: const EdgeInsets.only(top: 10, bottom: 15), height: 1, width: 100),
          ),
          Expanded(
            child: Padding(
                ...
                () => Column(
                  ...
                  children: [
                    Text(
                      ...
                      style: TextStyleCustom.unboundedSemiBold600(color: textDarkGrey(context), fontSize: 13),
                      maxLines: 2,

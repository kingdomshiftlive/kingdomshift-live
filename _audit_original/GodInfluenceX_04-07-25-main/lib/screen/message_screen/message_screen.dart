              ...
              children: [
                Padding(
                  ...
                  child: Text(LKey.messages.tr,
                      style: TextStyleCustom.unboundedMedium500(fontSize: 15, color: textDarkGrey(context))),
                ),
                CustomTabSwitcher(
                  ...
                  onTap: (index) {
                    ...
                    controller.pageController
                        .animateToPage(index, duration: const Duration(milliseconds: 300), curve: Curves.linear);
                  },

                  ...
                  children: [
                    PageView(
                      ...
                      children: [
                        ...
                        MusicCategoryGrid(musicCategories: controller.musicCategoryList),
                        MusicList(musicList: controller.savedMusicList),
                      ],
                    ),
                    if (controller.isSearch.value) MusicList(musicList: controller.searchMusicList),
                    if (controller.isMusicDownloading.value) const LoaderWidget()
                  ],
                ),
              ),
            ),

        ...
        itemBuilder: (context, index) {
          ...
          return InkWell(
            onTap: () {
              ...
              Get.bottomSheet(CategoryMusicSheet(musicCategory: musicCategory), isScrollControlled: true).then(
                (value) {
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyleCustom.outFitRegular400(fontSize: 13, color: textLightGrey(context)),
                  )
                ],
              ),
            ),

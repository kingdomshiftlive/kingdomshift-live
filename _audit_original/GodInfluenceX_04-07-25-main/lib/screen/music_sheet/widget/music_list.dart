...
class MusicCard extends StatelessWidget {
  ...
  const MusicCard({super.key, required this.music, required this.controller, this.isCategorySheet = false});
        ...
        child: Row(
          children: [
            ...
            Expanded(
              ...
              children: [
                Text(music.title ?? '',
                    style: TextStyleCustom.outFitMedium500(fontSize: 15, color: textDarkGrey(context)),

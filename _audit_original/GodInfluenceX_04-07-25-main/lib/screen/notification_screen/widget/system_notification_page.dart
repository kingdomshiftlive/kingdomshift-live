    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(data.title ?? '', style: TextStyleCustom.outFitMedium500(fontSize: 16, color: textDarkGrey(context))),
          DetectableText(
            text: data.description ?? '',
            basicStyle: TextStyleCustom.outFitLight300(fontSize: 15, color: textLightGrey(context)),
            detectionRegExp: detectionRegExp(atSign: false, hashtag: false, url: true)!,
            detectedStyle: TextStyleCustom.outFitMedium500(color: themeAccentSolid(context)),
            onTap: (p0) {

...
class _PostAnimationLikeState extends State<PostAnimationLike> with SingleTickerProviderStateMixin {
...
class PhotoLikeService {
  ...
  like(TapDownDetails details,
    ...
    final RenderBox? box = likeKey.currentContext?.findRenderObject() as RenderBox?;
    if (box == null) return;

...
class PostViewCenter extends StatelessWidget {
  ...
  const PostViewCenter({super.key, required this.post, this.onHeartAnimationEnd, required this.onDoubleTap});
...
class _PostTextViewState extends State<PostTextView> {
  ...
  Widget build(BuildContext context) {
    TextStyle collapsedStyle = TextStyleCustom.outFitLight300(
        fontSize: 15, color: widget.basicTextColor ?? textLightGrey(context), opacity: .8);
        ...
        children: [
          ReadMoreText(
            ...
            style: TextStyleCustom.outFitRegular400(
                color: widget.basicTextColor ?? textDarkGrey(context), fontSize: 15, opacity: widget.basicTextOpacity),
            annotations: [
              Annotation(
                ...
                spanBuilder: ({required String text, TextStyle? textStyle}) => TextSpan(
                    ...
                    style: textStyle?.copyWith(
                      color: widget.hashtagTextColor ?? themeAccentSolid(context),
                      fontFamily: FontRes.outFitMedium500,
                      fontSize: 15,
                    ),
                    recognizer: TapGestureRecognizer()
                      ..onTap = () {
                        Get.to(() => HashtagScreen(hashtag: text, index: 1), preventDuplicates: false);
                      }),
              ),
              Annotation(
                  ...
                  return TextSpan(
                    ...
                    recognizer: TapGestureRecognizer()
                      ..onTap = () async {
                        ...
                        User? mentionUser = widget.mentionUsers.firstWhereOrNull((element) => element.username == id);
                        if (mentionUser != null) {
                          NavigationService.shared.openProfileScreen(mentionUser);
                        }
                      },
                  );
                },
    ...
    return DoubleTapDetector(
      ...
      child: Container(
        ...
        child: ClipSmoothRect(
          radius: SmoothBorderRadius(cornerRadius: radius ?? 8, cornerSmoothing: 1),
          child: Stack(
            ...
            children: [
              ...
              if ((post.images ?? []).length > 1)
                CustomPageIndicator(length: (post.images ?? []).length, selectedIndex: selectedIndex),
              Align(
                ...
                child: InkWell(
                  ...
                  child: const Padding(
                    ...
                    child: CustomBgCircleButton(image: AssetRes.icExpand, size: Size(30, 30)),
                  ),
                ),
              )
            ],
    ...
    return DoubleTapDetector(
      ...
      onTap: isFromChat
          ...
          : () {
              if (post?.postType == PostType.podcast) {
                Get.to(() => PodcastDetailScreen(post: post!));
              } else {
      ...
      child: Container(
        ...
        constraints: BoxConstraints(
            ...
            minWidth: MediaQuery.of(context).size.width),
        child: ClipSmoothRect(
          radius: SmoothBorderRadius(cornerRadius: radius ?? 10, cornerSmoothing: 1),
          child: Stack(
            ...
            children: [
              ...
              Container(
                height: 35,
                width: 35,
                decoration: BoxDecoration(shape: BoxShape.circle, color: textDarkGrey(context).withValues(alpha: .4)),
                alignment: Alignment.center,
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text(
                          "PODCAST",
                          style: TextStyleCustom.outFitSemiBold600(color: Colors.white, fontSize: 10),
                        ),
                      ],
                    ),
                  ),

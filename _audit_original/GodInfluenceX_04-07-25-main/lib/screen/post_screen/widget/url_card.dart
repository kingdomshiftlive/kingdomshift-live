          ...
          Container(
            ...
            decoration: ShapeDecoration(
              shape: SmoothRectangleBorder(
                  borderRadius: SmoothBorderRadius(cornerRadius: 9, cornerSmoothing: 1),
              ...
              children: [
                Container(
                  ...
                  decoration: ShapeDecoration(
                    shape: const SmoothRectangleBorder(
                      borderRadius:
                          SmoothBorderRadius.horizontal(left: SmoothRadius(cornerRadius: 8, cornerSmoothing: 1)),
                    ),
                  ...
                  child: ClipRRect(
                    borderRadius:
                        const SmoothBorderRadius.horizontal(left: SmoothRadius(cornerRadius: 8, cornerSmoothing: 1)),
                    child: CustomImage(
                ...
                Expanded(
                  ...
                  children: [
                    Text(
                      metadata?.title ?? '',
                      style: TextStyleCustom.outFitRegular400(color: textDarkGrey(context), fontSize: 15),
                      maxLines: 2,

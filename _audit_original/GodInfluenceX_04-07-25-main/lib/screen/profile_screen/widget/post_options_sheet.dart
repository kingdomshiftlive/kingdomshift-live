      ...
      children: [
        Container(
          ...
          child: SafeArea(
            ...
            child: Column(
              children: [
                const CustomDivider(margin: EdgeInsets.symmetric(vertical: 10), width: 120),
                Column(
                          ...
                          onTap: () {
                            ...
                            switch (data) {
                              case PublishType.feed:
                                Get.to(() =>
                                    CreateFeedScreen(createType: CreateFeedType.feed, onAddPost: controller.onAddPost));
                              ...
                              case PublishType.podcast:
                                Get.to(() => CreateFeedScreen(
                                    createType: CreateFeedType.podcast, onAddPost: controller.onAddPost));
...
class PostOptionIconWithText extends StatelessWidget {
  ...
  const PostOptionIconWithText({super.key, required this.image, required this.text, required this.onTap});
        ...
        children: [
          InkWell(
            ...
            child: Padding(
              ...
              child: Row(
                children: [
                  Image.asset(image, color: textDarkGrey(context), height: 35, width: 35),
...
enum PublishType {
  ...
  static const Map<PublishType, String> images = {
    ...
    PublishType.podcast: AssetRes.icReel,
  ...
  static Map<PublishType, String> titles = {
    ...
    PublishType.podcast: LKey.podcast.tr,

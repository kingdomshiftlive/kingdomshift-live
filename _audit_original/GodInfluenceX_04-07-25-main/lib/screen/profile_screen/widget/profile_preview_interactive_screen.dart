...
class ProfilePreviewInteractiveScreen extends StatefulWidget {
  ...
  @override
  State<ProfilePreviewInteractiveScreen> createState() => _ProfilePreviewInteractiveScreenState();
}

class _ProfilePreviewInteractiveScreenState extends State<ProfilePreviewInteractiveScreen>
  ...
  void _onDragEnd(DragEndDetails details) {
    final shouldPop = _dragOffset.distance > 120 || (details.primaryVelocity?.abs() ?? 0) > 300;
  ...
  Widget build(BuildContext context) {
    ...
    final dragPercent = (_dragOffset.distance / screenSize.shortestSide).clamp(0.0, 1.0);

          ...
          child: SafeArea(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(30), border: Border.all(color: textDarkGrey(context))),
              child: DetectableTextField(
                  enabled: reel.canComment == 1,
                  controller: helper.detectableTextController,
                  focusNode: helper.detectableTextFocusNode,
                  style: TextStyleCustom.outFitRegular400(color: bgLightGrey(context), fontSize: 16),
                      ...
                      suffixIcon: Padding(
                        ...
                        child: InkWell(
                          onTap: () => helper.onCommentPost(
                              reel: reel, commentType: CommentType.text, onUpdateComment: controller.onUpdateComment),
                          child: Text(LKey.post.tr,
                              style:
                                  TextStyleCustom.unboundedMedium500(fontSize: 15, color: themeAccentSolid(context))),
                        ),
                      ),

...
enum ReportType { post, user, comment, story }
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          BottomSheetTopView(
              title: LKey.reportPost.trParams({'reportType': _reportTypeLabel}).capitalize ?? ''),
          Expanded(
                ...
                Obx(
                  () {
                    ...
                    return CustomDropDownBtn(
                      items: reportList,
                      selectedValue: reportList.firstWhere((e) => e.id == selected?.id, orElse: () => reportList.first),
                      onChanged: (value) {
                        if (value != null) {
                ...
                Container(
                  ...
                  child: TextField(
                      ...
                      decoration: InputDecoration(
                          ...
                          hintStyle: TextStyleCustom.outFitLight300(fontSize: 17, color: textLightGrey(context))),
                      expands: true,
                      minLines: null,
                      maxLines: null,
                      style: TextStyleCustom.outFitLight300(fontSize: 17, color: textLightGrey(context))),

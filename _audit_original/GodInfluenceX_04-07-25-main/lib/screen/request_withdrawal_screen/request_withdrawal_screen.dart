        ...
        Expanded(
          ...
          child: Column(
            ...
            children: [
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                            ...
                            children: [
                              Obx(
                                () => Text(
                                  ...
                                  style: TextStyleCustom.outFitExtraBold800(color: textDarkGrey(context), fontSize: 28),
                                ),
                              ),
                          ...
                          Text(AppRes.equal,
                              style: TextStyleCustom.outFitSemiBold600(color: textDarkGrey(context), fontSize: 26)),
                          Column(
                            children: [
                              Text(
                                controller.myUser.value
                                        ?.coinEstimatedValue(controller.settings.value?.coinValue?.toDouble())
                                        .currencyFormat ??
                                    '',
                                style: TextStyleCustom.outFitExtraBold800(color: textDarkGrey(context), fontSize: 28),
                              ),
              ...
              TextFieldCustom(
                ...
                inputFormatters: [
                  ...
                  LengthLimitingTextInputFormatter(
                      (controller.myUser.value?.coinWallet?.toInt() ?? 0).toString().length), // Dynamic limit
                ],
                ...
                () => TextFieldCustom(
                  ...
                  prefixIcon: Container(
                      ...
                      child: Text(
                        ...
                        style: TextStyleCustom.outFitLight300(fontSize: 20, color: whitePure(context)),
                      )),
                ),
              ),
              Padding(
                ...
                child: Text(LKey.selectGateway.tr,
                    style: TextStyleCustom.outFitRegular400(color: textDarkGrey(context), fontSize: 17)),
              ),
              Obx(() {
                var listFromApi = (controller.settings.value?.redeemGateways ?? []).map((e) => e.title ?? '').toList();
                var redeemGateways = listFromApi.isEmpty ? [AppRes.emptyGatewayMessage] : listFromApi;
              ...
              Container(margin: const EdgeInsets.symmetric(vertical: 40), child: const PrivacyPolicyText()),
            ],
          ),
        ))
      ],

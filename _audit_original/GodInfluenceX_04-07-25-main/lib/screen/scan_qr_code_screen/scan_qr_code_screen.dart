...
import 'package:google_mlkit_barcode_scanning/google_mlkit_barcode_scanning.dart' as qr;
...
class _ScanQrCodeScreenState extends State<ScanQrCodeScreen> {
  final MobileScannerController controller =
      MobileScannerController(detectionSpeed: DetectionSpeed.normal, detectionTimeoutMs: 3000);
                ...
                SizedBox(
                    ...
                    child: MobileScanner(
                      ...
                      onDetect: (result) async {
                        ...
                        if (url.isNotEmpty) {
                          controller.pause();
                          fetchDetailFromUrl(result.barcodes.first.rawValue ?? '');
                        } else {
                    ...
                    child: InkWell(
                      ...
                      child: Container(
                        ...
                        child: Row(
                          ...
                          spacing: 12,
                          children: [
                            Image.asset(AssetRes.icUploadGallery, width: 28, height: 28),
                            Text(
  ...
  void fetchDetailFromUrl(String url) async {
    ...
    ApiService.instance.callGet(url: 'https://api2.branch.io/v1/url?url=$url&branch_key=$branchKey').then((value) {
      _navigateToProfileScreen(int.parse(value['data']['user_id'].toString()));
    });
  }
  ...
  void onUploadFromGallery() async {
    XFile? image = await MediaPickerHelper.shared.pickImage(source: ImageSource.gallery);
    ...
    try {
      final List<qr.Barcode> barcodes = await barcodeScanner.processImage(inputImage);

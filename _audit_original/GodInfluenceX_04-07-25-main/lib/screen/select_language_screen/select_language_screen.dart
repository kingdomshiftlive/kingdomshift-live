...
class SelectLanguageScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final controller = Get.put(SelectLanguageScreenController(languageNavigationType));
    return Scaffold(
      body: Stack(
        children: [
          const ThemeBlurBg(),
              ...
              children: [
                switch (languageNavigationType) {
                            ...
                            Expanded(
                              ...
                              children: [
                                Text(
                                  ...
                                  style: TextStyleCustom.unboundedBlack900(fontSize: 25, color: whitePure(context)),
                                ...
                                Text(
                                  ...
                                  style: TextStyleCustom.unboundedBlack900(
                                      fontSize: 25, color: whitePure(context), opacity: .5),
                                  overflow: TextOverflow.ellipsis,
                                  maxLines: 1,
                                ),
                              ],
                  ...
                  LanguageNavigationType.fromSetting => CustomAppBar(
                      ...
                      titleStyle: TextStyleCustom.unboundedSemiBold600(fontSize: 15, color: whitePure(context)),
                ...
                Expanded(
                  child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Obx(
                          () {
                            bool isSelected = language == controller.selectedLanguage.value;
                            return Container(
                              height: 60,

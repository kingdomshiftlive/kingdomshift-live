...
class SelectedMusicSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
        ...
        child: Column(
          children: [
            BottomSheetTopView(title: LKey.selectMusic.tr, sideBtnVisibility: true),
            Expanded(
              ...
              child: Column(
                children: [
                  ...
                  Text(selectedMusic.music?.title ?? '',
                      style: TextStyleCustom.outFitMedium500(color: textDarkGrey(context), fontSize: 15)),
                  Text(
                    ...
                    () => AnimatedOpacity(
                      ...
                      child: FittedBox(
                        child: Container(
                          ...
                          child: Obx(
                            () => Text(
                              Duration(milliseconds: controller.audioStartInMilliSec.value).printDuration,
                  ...
                  InkWell(
                    ...
                    child: Container(
                      ...
                      child: Obx(
                        () => Image.asset(
                          controller.isPlaying.value ? AssetRes.icPause : AssetRes.icPlay,

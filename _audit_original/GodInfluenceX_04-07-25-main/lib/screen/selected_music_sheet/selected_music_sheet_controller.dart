...
class SelectedMusicSheetController extends BaseController {
  ...
  SelectedMusicSheetController(
      this.videoDurationInMs, this.selectedMusic); // Function(SelectedMusic? music)? onMusicAdd;
  ...
  void initPlayer() async {
    Loggers.info('INITIAL VIDEO DURATION SECOND : (${videoDurationInMs / 1000})');
    ...
    try {
      ...
      DebounceAction.shared.call(() {
        scrollController.animateTo(((selectedMusic.audioStartMS ?? 0) / 1000) * barTotalWidth * oneBarValue,
  ...
  void onContinueTap() async {
    ...
    if (audioTotalMilliSec > videoDurationInMs && (audioTotalMilliSec - audioStartingMilliSec) < videoDurationInMs) {
    ...
    onPause();
    SelectedMusic music = SelectedMusic(selectedMusic.music, audioStartingMilliSec, selectedMusic.downloadedURL,
...
class SelectedMusic {
  ...
  SelectedMusic(this.music, this.audioStartMS, this.downloadedURL, this.endMilliSec);

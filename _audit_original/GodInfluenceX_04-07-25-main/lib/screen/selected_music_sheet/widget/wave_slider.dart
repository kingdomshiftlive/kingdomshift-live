...
class WaveSlider extends StatelessWidget {
  ...
  const WaveSlider({super.key, required this.audioDuration, required this.videoDuration, required this.controller});
              ...
              SizedBox(
                ...
                child: FittedBox(
                  ...
                  child: ClipSmoothRect(
                    radius: SmoothBorderRadius(cornerRadius: controller.borderWidth / 2, cornerSmoothing: 1),
                    child: Container(
                          ...
                          child: Obx(
                            () {
                              return AnimatedContainer(
                                ...
                                width: max(
                                    0,
                                    (controller.boxWidth - controller.borderWidth) *

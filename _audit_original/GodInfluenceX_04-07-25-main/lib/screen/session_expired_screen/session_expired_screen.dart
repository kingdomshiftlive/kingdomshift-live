            ...
            child: SafeArea(
              child: Column(
                ...
                children: [
                  ...
                  Image.asset(widget.type.icon, height: 150, width: 150, color: whitePure(context)),
                  Expanded(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(widget.type.title.tr,
                            style: TextStyleCustom.unboundedRegular400(color: whitePure(context), fontSize: 20)),
                        Obx(() {
                          final helpMail = settings.value?.helpMail ?? '';

                          final description = widget.type.description(value: helpMail).tr;

                          final parts = description.split(helpMail);

                          return RichText(
                            text: TextSpan(
                              style: TextStyleCustom.outFitRegular400(color: bgGrey(context), fontSize: 17),
                              children: [
                                ...
                                TextSpan(
                                    ...
                                    style: TextStyleCustom.outFitBold700(color: bgGrey(context), fontSize: 17)),
...
enum SessionType {
  ...
  String description({String? value}) {
    switch (this) {
      ...
      case SessionType.unauthorized:
        return LKey.sessionExpiredMessage.trParams({'app_name': AppRes.appName});
    }
  }

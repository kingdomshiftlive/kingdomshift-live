          ...
          child: Column(
            ...
            children: [
              ...
              SettingIconTextWithArrow(
                ...
                onTap: () {
                  Get.to(() => const SelectLanguageScreen(languageNavigationType: LanguageNavigationType.fromSetting));
                },
              ),
              SettingIconTextWithArrow(
                ...
                () {
                  return SettingIconTextWithArrow(
                    ...
                    widget: CustomToggle(
                      ...
                      onChanged: (value) {
                        controller.onChangedToggle(value, SettingToggle.showMyFollowings);
                      },
                    ),
                  );
                },
                  ...
                  return SettingIconTextWithArrow(
                    ...
                    widget: CustomToggle(
                      ...
                      onChanged: (value) async {
                        controller.onChangedToggle(value, SettingToggle.receiveMessage);
                      },
                    ),
                  );
                },
              ...
              SettingIconTextWithArrow(
                ...
                onTap: () {
                  Get.to(() => const TermAndPrivacyScreen(type: TermAndPrivacyType.termAndCondition));
                },
              ),
              SettingIconTextWithArrow(
                icon: AssetRes.icReport,
                ...
                onTap: () {
                  Get.to(() => const TermAndPrivacyScreen(type: TermAndPrivacyType.privacyPolicy));
                },
              ),
              SettingIconTextWithArrow(
      ...
      return InkWell(
        ...
        child: Container(
          ...
          decoration: ShapeDecoration(
              shape: SmoothRectangleBorder(borderRadius: SmoothBorderRadius(cornerRadius: 7, cornerSmoothing: 1)),
          ...
          child: Row(
            ...
            children: [
              ...
              if (!isVerify) Image.asset(AssetRes.icForwardArrow, width: 24, height: 20, color: whitePure(context))
            ],
          ),
        ),
      );
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Text(
        ...
        style: TextStyleCustom.outFitMedium500(fontSize: 13, color: textLightGrey(context)).copyWith(letterSpacing: 2),
      ),
    );
  }
}

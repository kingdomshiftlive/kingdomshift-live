        ...
        child: Column(
          children: [
            ...
            CustomSearchTextField(
                margin: const EdgeInsets.symmetric(horizontal: 10), onChanged: controller.onSearchUser),
              ...
              child: Obx(() {
                return GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ChatThread chatConversation = controller.filterChatsUsers[index];
                            ...
                            Expanded(
                              child: Padding(
                                ...
                                child: Text(chatUser?.username ?? '',
                                    style: TextStyleCustom.outFitRegular400(color: textDarkGrey(context), fontSize: 14),

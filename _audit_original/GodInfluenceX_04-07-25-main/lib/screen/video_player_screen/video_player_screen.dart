...
class _VideoPlayerScreenState extends State<VideoPlayerScreen> {
  ...
  void initState() {
    super.initState();
    post = widget.post;
    _videoPlayerController.value = VideoPlayerController.networkUrl(Uri.parse(post?.video?.addBaseURL() ?? ''))
                        ...
                        child: VisibilityDetector(
                          ...
                          child: SizedBox.expand(
                            child: FittedBox(
                                ...
                                child: SizedBox(
                                    width: width, height: height, child: VideoPlayer(_videoPlayerController.value!))),
                          ),
                        ),
                      )
                    else
                              ...
                              Column(
                                ...
                                children: [
                                  SafeArea(
                                    bottom: false,
                                    child:
                                        CustomBackButton(padding: const EdgeInsets.all(10), color: whitePure(context)),
                                  ),
                                  Stack(
                                    alignment: Alignment.bottomCenter,
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            PlayerActionView(
                                                value: value, videoPlayerController: _videoPlayerController),
                                            // UserInfoData(
                                            //     post: post,
              ...
              children: [
                ...
                InkWell(
                  ...
                  child: Text(post?.user?.fullname ?? '',
                      style: TextStyleCustom.outFitLight300(color: whitePure(context), fontSize: 16)),
                )
              ],
            ),
          ),

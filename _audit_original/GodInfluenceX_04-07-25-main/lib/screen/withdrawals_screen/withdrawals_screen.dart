          ...
          Expanded(child: Obx(
            () {
              return controller.isLoading.value && controller.withdraws.isEmpty
                  ? const LoaderWidget()
                  : NoDataView(
                      showShow: !controller.isLoading.value && controller.withdraws.isEmpty,
                                  ...
                                  child: Row(
                                    children: [
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Text(
                                              ...
                                              style: TextStyleCustom.unboundedSemiBold600(color: textDarkGrey(context)),
                                            ),
                                            Text(
                                            ...
                                            Text(
                                              (withdraw.createdAt ?? '').formatDate1,
                                              style: TextStyleCustom.outFitLight300(
                                                  color: textLightGrey(context), fontSize: 13),
                                            ),
                                          ],
                                      ...
                                      Column(
                                        children: [
                                          Text(
                                            (double.parse(withdraw.amount ?? '0')).currencyFormat,

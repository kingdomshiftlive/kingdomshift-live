...
class AppRes {
  static String appName = 'GodInfluenceX';
  ...
  static const int battleStartInSecond = 10; // Time before the battle officially starts (in seconds)
  static const int battleDurationInMinutes = 1; // Total duration of the battle (in minutes)
  static const int battleEndMainViewInSecond = 10; // Duration to show the main view after battle ends (in seconds)
  ...
  static const int paginationLimitDetectWord = 5; // For mention user and hashtag

  // Profile image
  static const int compressQualityInKB = 100; // This value kb (Example: 100 means 100kb)
  ...
  // Request Withdrawal
  static const emptyGatewayMessage = 'Please add Payment Gateway List in Admin Panel';

  static const emptyReportReason = 'Please add Report Reason List in Admin Panel';

  // detectable RegExp
  static RegExp detectableReg = RegExp(r'[@#][\w.-]+'); // Detects @username or #hashtag
  static RegExp userNameRegex = RegExp(r'@([a-zA-Z0-9_.-]+)'); // Captures username without '@'
  static RegExp hashTagRegex = RegExp(r'#([\w.-]+)'); // Captures hashtag without '#'
  static RegExp urlRegex = RegExp(r'(?:(?:https?|ftp)://)?[\w/\-?=%.]+\.[\w/\-?=%.]+');
  ...
  // Play store link
  static const String whatsappPlayStoreLink = "https://play.google.com/store/apps/details?id=com.whatsapp&hl=en_IN";

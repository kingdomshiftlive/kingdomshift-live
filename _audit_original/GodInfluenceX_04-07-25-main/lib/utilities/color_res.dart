...
class ColorRes {
  ...
  static const Color themeGradient1 = Color(0xFF008080);
  static const Color themeGradient2 = Color(0xFF008080);
  static const Color themeAccentSolid = Color(0xFF008080);

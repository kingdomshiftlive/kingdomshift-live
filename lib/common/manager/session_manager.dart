...
class SessionManager {
  ...
  bool get isAutoplayEnabled {
    return storage.read(SessionKeys.autoplayEnabled) ?? true;
  }

  void setAutoplayEnabled(bool isEnabled) {
    storage.write(SessionKeys.autoplayEnabled, isEnabled);
  }
...
class SessionKeys {
  ...
  static const autoplayEnabled = "autoplay_enabled";
}

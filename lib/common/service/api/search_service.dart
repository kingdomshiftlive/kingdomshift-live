...
class SearchService {
  ...
  Future<List<Post>> searchPost(
      {String? keyword, required String type, num? lastItemId}) async {
  ...
  Future<List<Hashtag>> searchHashtags(
    ...
    HashtagModel model = await ApiService.instance.call(
        url: WebService.addPostStory.searchHashtags,
        fromJson: HashtagModel.fromJson,
        param: {
          Params.limit: AppRes.paginationLimit,

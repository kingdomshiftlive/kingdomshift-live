...
class EditProfileScreenController extends BaseController {
  ...
  void onSaveTap() async {
    ...
    bool isModerationPassed = true;
    print(
        'SAVE TAP - fullname: ${fullNameController.text} photo: ${fileProfileImage.value?.path}');
  ...
  void onLinkAddEditDelete(Link link, LinkType type) {
    switch (type) {
      case LinkType.add:
        links.add(link);
      case LinkType.edit:

      ...
      Positioned(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(color: KColors.gold, borderRadius: BorderRadius.circular(10)),
            child: const Text('Follow', style: TextStyle(color: KColors.white, fontSize: 8, fontWeight: FontWeight.bold)),
          ),
        ]),
      ),

    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          const Align(alignment: Alignment.bottomCenter, child: BlackGradientShadow(height: 200)),
          SafeArea(
                      ...
                      InkWell(
                        ...
                        child: Container(
                          ...
                          child: GradientIcon(
                            ...
                            child: Image.asset(AssetRes.icCameraFlip, width: 26, height: 26),
                          ),
                        ),
                      ),
                      Container(
                        ...
                        child: TextField(
                          ...
                          decoration: InputDecoration(
                              ...
                              hintStyle: TextStyleCustom.outFitLight300(
                                  fontSize: 17, color: whitePure(context).withValues(alpha: .7))),
                          expands: true,
                          maxLines: null,
                          minLines: null,

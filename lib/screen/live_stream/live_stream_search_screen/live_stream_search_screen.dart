...
import 'package:shortzz/screen/live_stream/livestream_history/livestream_history_screen.dart';
...
import '../../audio_live_stream_screen/create_audio_live_screen/create_audio_live_stream.dart';

class LiveStreamSearchScreen extends StatelessWidget {
  final User? myUser;

  const LiveStreamSearchScreen({super.key, required this.myUser});
      ...
      children: [
        ...
        Column(
          children: [
            ...
            const LiveStreamSearchTopViewAudio(),
            const SizedBox(
              height: 10,
            ),
            ...
            Container(
              ...
              decoration: ShapeDecoration(
                shape: SmoothRectangleBorder(
                    borderRadius: SmoothBorderRadius(cornerRadius: 10, cornerSmoothing: 0),
              ...
              child: InkWell(
                onTap: () {
                  String currentUserId = myUser?.id.toString() ?? '';
                  Get.to(LivestreamHistoryScreen(
                ...
                child: Row(
                  children: [
                    ...
                    Text(LKey.liveRecordings.tr.toUpperCase(),
...
class LiveStreamSearchTopViewAudio extends StatelessWidget {
  const LiveStreamSearchTopViewAudio({super.key});
  ...
  Widget build(BuildContext context) {
    return Stack(
      ...
      children: [
            ...
            child: Container(
              ...
              child: Row(
                children: [
                  Image.asset(AssetRes.icLive, color: whitePure(context), height: 22, width: 22),
                  const SizedBox(width: 5),
                  Text("Audio ${LKey.livestreams.tr.toUpperCase()}",
                      style: TextStyleCustom.unboundedRegular400(fontSize: 12, color: whitePure(context)))
                ],
              ),
            ),
        ...
        InkWell(
          onTap: () {
            Get.to(() => CreateAudioLiveStreamScreen());
          },
          child: Container(
            height: 30,

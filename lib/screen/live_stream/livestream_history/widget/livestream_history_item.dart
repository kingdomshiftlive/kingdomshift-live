...
class _LivestreamItemWidgetState extends State<LivestreamItemWidget> {
  ...
  Widget build(BuildContext context) {
    LivestreamHistoryController controller =
        Get.find<LivestreamHistoryController>();
    return Card(
      elevation: 8,
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  PopupMenuButton(
                    popUpAnimationStyle:
                        const AnimationStyle(curve: Curves.easeInCubic),
                    ...
                    itemBuilder: (context) => [
                      PopupMenuItem(
                        ...
                        onTap: () async {
                          await controller
                              .deleteLivestreams(widget.livestream.id);

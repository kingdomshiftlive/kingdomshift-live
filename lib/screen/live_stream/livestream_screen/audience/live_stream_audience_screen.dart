...
class LiveStreamAudienceScreen extends StatelessWidget {
  ...
  const LiveStreamAudienceScreen({super.key, required this.livestream, required this.isHost});

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(LivestreamScreenController(livestream.obs, isHost));
          ...
          children: [
            ...
            KeyboardAvoider(
              child: Column(
                ...
                children: [
                  LiveStreamAudienceTopView(isAudience: true, controller: controller),
                  LiveStreamBottomView(isAudience: true, controller: controller),
                ],
              ),
            ),

...
class PodcastDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final controller =
        Get.put(PodcastDetailController(post), tag: '${post.id}');
                      ...
                      Positioned(
                        ...
                        child: InkWell(
                          ...
                          child: Container(
                            ...
                            child: Image.asset(AssetRes.icGiftNew,
                                width: 24, height: 24),
                          ),
                        ),
                      ),
              ...
              child: NestedScrollView(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            ReadMoreText(
                              ...
                              moreStyle: TextStyleCustom.outFitSemiBold600(
                ...
                body: Column(
                  children: [
                    ...
                    Expanded(
                        child: Obx(() => controller.commentController
                                    .getCommentsList.isEmpty &&
...
class PodcastDetailController extends BaseController {
  ...
  void _initComments() {
    ...
    commentController = Get.put(
        CommentSheetController(post.obs, null, null, false, commentHelper),
        tag: 'podcast_comment_${post.id}');
  }
